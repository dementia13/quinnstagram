...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.tbAction);
        ...
        // These two are for bottom toolbar buttons I'm trying to get to work
        Button btnPost = findViewById(R.id.miPlus);
        Button btnUser = findViewById(R.id.miUser);
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Toolbar bottomBar = findViewById(R.id.tbBottom);
        setSupportActionBar(bottomBar);
        bottomBar.setLogo(R.drawable.instagram_home_outline_24);
...
/*
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        MenuItem actionViewItem = menu.findItem(R.id.miUser);
        View view = MenuItemCompat.getActionView(actionViewItem);
        Button b = view.findViewById(R.id.btnUser);
